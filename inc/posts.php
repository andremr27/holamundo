...
function get_post( $post_id ){
    ...
    //tambien saneo las variables que no son string, los numeros por ejemplo, con la funcion INTVAL()
...
function insert_post ( $title, $excerpt, $content ){
    ...
    //Con esta funcion me aseguro de sanear lo que me llega de los inputs de los formularios antes de meterlo en la tabla de mi bbdd
